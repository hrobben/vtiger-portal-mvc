...
class Bootstrap {
    ...
    private function _callControllerMethod() {
        ...
        switch ($length) {
            case 9:
                //Controller->Method(Param1, Param2, Param3, Param4)  localhost/mvc/{index}/(invoice/true/index/true/7924/com_vtpaccounts.zip/1)
            ...
            case 7:
                //Controller->Method(Param1, Param2, Param3, Param4)  localhost/mvc/{index}/(invoice/true/index/true/7924/com_vtpaccounts.zip)
                $this->_controller->{$this->_url[1]}($this->_url[2], $this->_url[3], $this->_url[4], $this->_url[5], $this->_url[6]);
                break;

            case 6:
                //Controller->Method(Param1, Param2, Param3, Param4)  localhost/mvc/{index}/(invoice/true/index/true/7924)
